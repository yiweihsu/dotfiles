...
const float TRAIL_SIZE = 0.72; // 0.0 = all corners move together. 1.0 = max smear (leading corners jump instantly)
const float THRESHOLD_MIN_DISTANCE = 0.2; // min distance to show trail (units of cursor height)
...
const float FADE_EXPONENT = 3.0; // exponent for fade gradient along the trail
